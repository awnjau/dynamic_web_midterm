...
const CountryFlag = () => {
  ...
  function getPopulation(countryName) {
    ...
    return populationDataEntry ? populationDataEntry.population : `Oops, it looks like we don't have this one! Try checking Google :(`;
  }
    ...
    <div>
      {randomCountry && (
        <div className={styles.CountryInfoWrapper} >
          <h1>Guess the Population of...{randomCountry.name}</h1>
